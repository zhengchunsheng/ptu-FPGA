...
HD_PWD='D:/FPGA project/Color Recognition/Color_Demo/Color_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Color_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Color_Demo.tcl -notrace
