...
HD_PWD='D:/FPGA project/Color Recognition/Color_Demo/Color_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Color_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Color_Demo.tcl
